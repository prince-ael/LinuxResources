...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery(){
        ...
        if(githubSearchQuery.length() == 0){
            ...
            mSearchBoxEditText.setError("You haven't typed anything");
            return;
        }
        URL mUrl= NetworkUtils.buildUrl(githubSearchQuery);
        mUrlDisplayTextView.setText((mUrl == null)?"Something is wrong" : mUrl.toString());
    }
