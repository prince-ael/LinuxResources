...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String myThought = "Wvwery TThhiinngg iiss mmeeaanniinngglleessss";

        // TODO (6) Replace the Toast with shareText, passing in the String from step 5
        Toast.makeText(this, myThought, Toast.LENGTH_LONG).show();
    }
    ...
    private void shareText(String param){
        ...
        ShareCompat.IntentBuilder sib = ShareCompat.IntentBuilder.from(this);
        sib.setChooserTitle(title);
        sib.setType(mimeType);
        sib.setText(param);
        sib.createChooserIntent();
    }
