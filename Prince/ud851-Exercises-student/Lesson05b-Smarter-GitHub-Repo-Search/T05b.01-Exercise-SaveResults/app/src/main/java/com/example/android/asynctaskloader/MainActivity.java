...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null && savedInstanceState.containsKey(QUERY_URL_KEY) && savedInstanceState.containsKey(RAW_JSON_KEY)){
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String mRawJSON = mSearchResultsTextView.getText().toString();

        outState.putString(QUERY_URL_KEY , queryURL);
        outState.putString(RAW_JSON_KEY , mRawJSON);
    }
}