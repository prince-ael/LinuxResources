...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            defaultValue = res.getBoolean(R.bool.pref_show_bass_default);
            mVisualizerView.setShowBass(sharedPreferences.getBoolean(key, defaultValue));
            Log.d("Key Bass" , key);
        }

        if(key.equals(getString(R.string.pref_show_treble_key))){
            defaultValue = res.getBoolean(R.bool.pref_show_treble_default);
            mVisualizerView.setShowTreble(sharedPreferences.getBoolean(key , defaultValue));
            Log.d("Key Treble" , key);
        }

        if(key.equals(res.getString(R.string.pref_show_midrange_key))){

            defaultValue = res.getBoolean(R.bool.pref_show_midrange_default);
            mVisualizerView.setShowMid(sharedPreferences.getBoolean(key , defaultValue));
            Log.d("Key Mid" , key);
        }
    }
