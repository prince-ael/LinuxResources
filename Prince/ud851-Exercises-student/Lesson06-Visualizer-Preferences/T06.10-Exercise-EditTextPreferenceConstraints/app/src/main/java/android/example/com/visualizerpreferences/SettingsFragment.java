    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if(key.equals(getString(R.string.pref_size_key))){
            ...
            try{
                ...
                float minSize = Float.parseFloat(value);

                if(minSize <= 0 || minSize > 3.0f){
                    Toast.makeText(getContext() , "Please Enter A Valid Number Between 1 and 3",Toast.LENGTH_SHORT).show();
                    return false;
                }
