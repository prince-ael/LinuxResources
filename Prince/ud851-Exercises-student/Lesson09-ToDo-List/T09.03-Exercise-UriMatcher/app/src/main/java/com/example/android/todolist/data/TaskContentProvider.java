...
public class TaskContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher(){
        ...
        UriMatcher lUriMatcher = new UriMatcher(UriMatcher.NO_MATCH);

        lUriMatcher.addURI(TaskContract.AUTHORITY , TaskContract.PATH_TASKS , TASKS);
        lUriMatcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS+"/#",TASK_WITH_ID);
