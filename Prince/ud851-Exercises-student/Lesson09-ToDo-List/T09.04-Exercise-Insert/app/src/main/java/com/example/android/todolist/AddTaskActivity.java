...
public class AddTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        taskDescriptionEt = (EditText) findViewById(R.id.editTextTaskDescription);
        mPriority = 1;
    }
    ...
    public void onClickAddTask(View view) {
        ...
        if(taskDescription.length() == 0){
            taskDescriptionEt.setError("Should Not Empty");
            return;
        }
        ...
        Uri insertedRowUri = resolver.insert(TaskContract.TaskEntry.CONTENT_URI , values);
        Toast t = Toast.makeText(this , insertedRowUri.toString() , Toast.LENGTH_SHORT);
        t.setGravity(Gravity.CENTER,0,0);
        t.show();
        taskDescriptionEt.getText().clear();
        finish();
    }
