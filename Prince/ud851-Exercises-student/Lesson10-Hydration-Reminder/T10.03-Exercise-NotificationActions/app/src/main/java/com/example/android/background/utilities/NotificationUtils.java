...
public class NotificationUtils {
    ...
    private static final int IGNORE_ACTION_PENDING_INTENT_ID = 3030;
    private static final int DRINK_ACTION_PENDING_INTENT_ID = 3031;
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        PendingIntent waterReminderPendingIntent = PendingIntent.getService(context,
                IGNORE_ACTION_PENDING_INTENT_ID,
    ...
    //      CompletedTODO (9) Create an Action for the user to ignore the notification (and dismiss it)
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context){
        ...
        PendingIntent drinkWaterPendingIntent = PendingIntent.getService(context,
                DRINK_ACTION_PENDING_INTENT_ID,
                drinkWaterIntent,
                PendingIntent.FLAG_UPDATE_CURRENT);
