...
public class ReminderUtilities {
    ...
    private static final int REMINDER_INTERVAL_MINUTES = 35;
    ...
    public static synchronized void scheduleChargingReminder(Context context){
        ...
        FirebaseJobDispatcher fJobDispatcher = new FirebaseJobDispatcher(driver);

        Job constraintReminderJob = fJobDispatcher.newJobBuilder()
                ...
                .build();
        fJobDispatcher.schedule(constraintReminderJob);
        sInitialized = true;
    }
