...
public class MainActivity extends AppCompatActivity implements
    ...
    private ChargingBroadcastReceiver mBroadcastReciever;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // and an IntentFilter
        mBroadcastReciever = new ChargingBroadcastReceiver();
    ...
    protected void onResume() {
        ...
        registerReceiver(mBroadcastReciever , mIntentFilter);
    }
    ...
    public void showCharging(boolean isCharging){
        ...
        if(isCharging){
            mChargingImageView.setColorFilter(Color.RED);
        }else{
            mChargingImageView.setColorFilter(Color.GRAY);
        }
    }
