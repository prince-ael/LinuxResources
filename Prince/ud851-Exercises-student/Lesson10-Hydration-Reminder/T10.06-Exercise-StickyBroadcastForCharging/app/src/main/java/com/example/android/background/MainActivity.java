...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            ...
            Intent stickyIntent = registerReceiver(null, iFilter);

            int extraStatus = stickyIntent.getIntExtra(BatteryManager.EXTRA_STATUS , -2);

            showCharging(extraStatus == BatteryManager.BATTERY_STATUS_CHARGING || extraStatus == BatteryManager.BATTERY_STATUS_FULL);
