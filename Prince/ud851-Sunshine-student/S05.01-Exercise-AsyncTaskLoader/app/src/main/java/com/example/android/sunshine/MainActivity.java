...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks {
    ...
    private static final String USER_PREFERRED_LOCATION = "preferedLocation";

    private static final int LOADER_ID = 792;
    ...
    private void loadWeatherData() {
        ...
        args.putString(USER_PREFERRED_LOCATION , location);
    ...
    public Loader onCreateLoader(int id, final Bundle args) {
        ...
        AsyncTaskLoader<String[]> aLoader = new AsyncTaskLoader<String[]>(this) {
            private String[] weatherDataCache;
            @Override
            public String[] loadInBackground() {

                String location = args.getString(USER_PREFERRED_LOCATION);
            ...
            protected void onStartLoading() {
                ...
                if(weatherDataCache != null && weatherDataCache.length > 0){
