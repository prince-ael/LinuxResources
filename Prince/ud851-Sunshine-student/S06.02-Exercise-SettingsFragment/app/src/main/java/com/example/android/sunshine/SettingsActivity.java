...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // SettingsFragment (4) Create SettingsFragment and extend PreferenceFragmentCompat
        ...
        // SettingsFragment (5) Override onCreatePreferences and add the preference xml file using addPreferencesFromResource
