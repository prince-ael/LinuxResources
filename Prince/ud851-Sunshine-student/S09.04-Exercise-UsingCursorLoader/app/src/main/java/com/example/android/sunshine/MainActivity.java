...
//  Completed (16) Create a String array containing the names of the desired data columns from our ContentProvider
    ...
    private String[] MAIN_FORECAST_PROJECTION = {WeatherContract.WeatherEntry.COLUMN_DATE,
...
//  Completed (17) Create constant int values representing each column name's position above
    ...
    public static final int POSITION_WEATHER_ID = 1;
    public static final int POSITION_MAX_TEMP   = 2;
    public static final int POSITION_MIN_TEMP   = 3;
    public static final int POSITION_PRESSURE   = 4;
    public static final int POSITION_SPEED      = 5;
