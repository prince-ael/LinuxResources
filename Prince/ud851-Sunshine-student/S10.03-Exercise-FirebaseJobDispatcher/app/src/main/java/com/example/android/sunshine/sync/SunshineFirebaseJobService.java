...
//  Comleted (5) Override onStartJob and within it, spawn off a separate ASyncTask to sync weather data
//              Comleted(6) Once the weather data is sync'd, call jobFinished with the appropriate arguments

//  Comleted (7) Override onStopJob, cancel the ASyncTask if it's not null and return true
