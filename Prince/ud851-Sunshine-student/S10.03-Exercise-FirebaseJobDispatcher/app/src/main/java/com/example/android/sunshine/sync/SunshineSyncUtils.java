...
//  Completed (10) Add constant values to sync Sunshine every 3 - 4 hours
    ...
    private static final int FLEX_INTERVAL_SECONDS = (int)TimeUnit.HOURS.toSeconds(SYNC_INTERVAL_HOUR - 2);
    private static final String SYNC_JJOB_TAG = "sync-job-tag";
