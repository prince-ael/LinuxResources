...
public final class SunshinePreferences {
    ...
    public static boolean isNotificationEnabled(Context context){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        String notifictionKey = context.getString(R.string.pref_enable_notifications_key);
        boolean defaultValue  = context.getResources().getBoolean(R.bool.pref_show_notification_default);

        return sp.getBoolean(notifictionKey , defaultValue);
    }
